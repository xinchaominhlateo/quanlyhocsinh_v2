  ...
  return (
    <div ref={ref} className="p-5" style={{ minHeight: '100vh' }}>
      <div className="text-center mb-5">
        ...
        <h4 className="fw-bold">TRƯỜNG THPT CẤP 3</h4>
        <hr />
...
<p><strong>Lớp học:</strong> {data?.hoc_sinh?.lop_hoc?.ten_lop || 'Chưa phân lớp'}</p>        <p><strong>Học kỳ:</strong> {data?.hoc_ki}</p>
      ...
      <div className="row mt-5 pt-5 text-center">
        ...
        <div className="col-6">
          ...
          <br /><br /><br />
          <p><strong>{data?.nguoi_thu || "Hiệu Trưởng"}</strong></p>
        </div>
      </div>
    </div>
  );
